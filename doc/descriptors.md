# Support for Output Descriptors in Reditcoin Core

Since Reditcoin Core v0.17, there is support for Output Descriptors. This is a
...
on Reditcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Reditcoin Core wallets, a convenience function `combo` is
