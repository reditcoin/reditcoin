...
"""Verify that starting reditcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start reditcoin with -h for help text")
        ...
        self.log.info("Start reditcoin with -version for version information")
        ...
        self.log.info("Start reditcoind with -fakearg to make sure it does not start")
