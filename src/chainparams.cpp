...
static CBlock CreateGenesisBlock(uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    const char* pszTimestamp = "NY Times 09/Feb/2021 Bitcoin tops 48,000 after Tesla discloses it bought 1.5 billion worth";
...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 1401600; // 4 years
        consensus.BIP16Height = 0;
        consensus.BIP34Height = 500;
        consensus.BIP34Hash = uint256();
        consensus.BIP65Height = 1500;
        consensus.BIP66Height = 1500;
        ...
        genesis = CreateGenesisBlock(1612880383, 2085577200, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        // assert(consensus.hashGenesisBlock == uint256S("0x12a765e31ffd4059bada1e25190f6e98c99d9714d334efa41a195a7e7e04bfe2"));
        // assert(genesis.hashMerkleRoot == uint256S("0x97ddfbbae6be97fd6cdf3e7ca13232a3afff2353e29badfab7f73011edd4ced9"));
	assert(consensus.hashGenesisBlock == uint256S("0xf66bfa59fba4f148c1c1b3383a3d1137b1c3690f7b41b1711b03fa5c65833c01"));
        assert(genesis.hashMerkleRoot == uint256S("0x7f122187b86dbaf9993acfa6fab9509b3765669ba31f6c1e145f97c01c31450a"));
        ...
        vSeeds.emplace_back("dnsseed.reditcoin.com");
        ...
        checkpointData = {
            {
		{0, uint256S("0xf66bfa59fba4f148c1c1b3383a3d1137b1c3690f7b41b1711b03fa5c65833c01")},
            }
        };
...
public:
	...
	/*
        vSeeds.emplace_back("seed-testnet.reditcoin.com");
	*/
