...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " reditcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  reditcoin-tx [options] <hex-tx> [commands]  Update hex-encoded reditcoin transaction\n" +
            "or:     reditcoin-tx [options] -create [commands]   Create hex-encoded reditcoin transaction\n" +
            "\n";
